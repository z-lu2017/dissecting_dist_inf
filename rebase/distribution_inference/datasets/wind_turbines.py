...
class DatasetInformation(base.DatasetInformation):
    def __init__(self, epoch_wise: bool = False):
        ...
        super().__init__(name="Wind_Turbines",
                         data_path="edp",
                         models_path="wind_turbines",
...
class _WindTurbineGearboxOilTemperature:
    def __init__(self, drop_senstive_cols=False):
        ...
        self.columns = [
            ...
            "generator_rpm", "rotor_rpm", "gearbox_oil_temp", "pitch_angle_bin"
        ]
    ...
    def load_data(self, test_ratio, random_state: int = 42):
        ...
        def s_split(this_df, rs=random_state):
            ...
            splitter = sss.split(
                this_df, this_df[["pitch_angle_bin", "gearbox_oil_temp"]])  # Statify based on pitch_angle and gearbox_oil_temp, so ration of each is abt the same in train/test split
...
if __name__ == "__main__":
    DS_info = DatasetInformation()
    DS_info.generate_victim_adversary_splits()
